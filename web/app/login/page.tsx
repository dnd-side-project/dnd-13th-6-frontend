    ...
    <div className="relative min-h-screen w-full">
      ...
      <Link
        href={
          ...
          'https://kauth.kakao.com/oauth/authorize?client_id=3255efd2af839833b26a422ca203c180&redirect_uri=https://api.runky.store/dev/api/auth/login/oauth2/code/kakao&response_type=code'
        }
